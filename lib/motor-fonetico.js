/**
 * Motor Fonético PT-BR — Standalone module
 *
 * Syllabification, stress detection, rhyme extraction, and phonetic profiling
 * for Brazilian Portuguese words.
 *
 * Usage (ES module):
 *   import { silabificar, perfilFonetico } from './motor-fonetico.js';
 *
 * Usage (CommonJS):
 ...
 *   // all exports available on globalThis.MotorFonetico
 */
...
const FAM_LABEL    = { pl:'plos+líq', fl:'fric+líq', af:'ch', lp:'lh', np:'nh', si:'simples', vz:'—', cx:'complexo' };
...
function calcClasse(p) {
    const pL = p.toLowerCase(), len = pL.length;
...
function perfilFonetico(palavra) {
    ...
    return {
        palavra: pL, silabas: sil, tonicaIndex: ti, numSilabas: numSil,
...
// ── Scoring (rhyme quality between two profiles) ───────────────
...
// ── Exports (UMD-style: works in Node CJS, ESM, and browsers) ─
const exports_ = {
    silabificar,
    identificarTonica,
    perfilFonetico,
...
if (typeof module !== 'undefined' && module.exports) {
    ...
    globalThis.MotorFonetico = exports_;
}
